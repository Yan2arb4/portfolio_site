...
import { getTechByNames } from 'src/app/models/tech';
...
export class ExperienceComponent {
  experiences: experience[] = [
    new experience(
      ...
      getTechByNames(['Visual Studio Code', 'C Programming Language', 'STM32 Nucleo Series', 'Electronics', 'Zephyr RTOS', 'ZTest Framework', 'Bash', 'Ubuntu', 'Scrum Methodology', 'Git']),
